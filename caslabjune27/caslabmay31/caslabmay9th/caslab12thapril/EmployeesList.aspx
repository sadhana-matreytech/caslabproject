...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br /><br />
      <asp:GridView ID="GridView1" runat="server" onrowdatabound="GridView1_RowDataBound" AutoGenerateColumns="False" CellPadding="4" class="table table-striped table-bordered"
  ForeColor="#333333" GridLines="None">
    ...
    <asp:button runat="server" ID="save" text="SAVE" class="btn btn-primary" OnClick="save_Click1" CausesValidation="false"></asp:button>
</asp:Content>
