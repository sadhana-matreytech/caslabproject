...
namespace caslab12thapril
{
    public partial class Admin : System.Web.UI.MasterPage
    {
        ...
        protected void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into AddEmployee(EmpId,EmpName,UserName,Qualification,Phone,Email,Password,position) values(@EmpId,@EmpName,@UserName,@Qualification,@Phone,@Email,@Password,@position)", con);
